...
import { NewCategoriesUrl, NewTagsUrl } from "../../../constants/urls";

// ----------------------------------------------------------------------

export default function TagsMoreMenu({
  tag_id,
  token,
  Arabic_name,
  English_name,
  ...
  */
  ...
  const handleConfirmEditCountry = () => {
    ...
    axios
      .post(`${NewTagsUrl}/update/${tag_id}`, data, { headers })
      .then((response) => {
      ...
      >
        {roles.includes(28) && (
          ...
          >
            ...
            <ListItemText
              primary={t("description.TagsEditPageButton")}
        ...
        >
          <DialogTitle>{t("description.TagsEditPageButton")} </DialogTitle>
        ...
        >
          <DialogTitle id="alert-dialog-title">
            {t("description.DeleteTagDialogTitle")}
          </DialogTitle>
          <DialogContent
          ...
          >
            <DialogContentText>
              {t("description.DeleteTagDialogMessage")}
            </DialogContentText>
          </DialogContent>
          <DialogActions>
