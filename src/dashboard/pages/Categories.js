 ...
 */ import { AllCategoriesUrl, NewCategoriesUrl } from "../constants/urls";
...
export default function Categories() {
  ...
  const TABLE_HEAD = [
    {
      id: "name",
      label: t("description.CategoryPageCategoryname"),
  ...
  */
  ...
  const handleAddNew = () => {
    ...
    axios
      .post(`${NewCategoriesUrl}/create`, data, { headers })
      .then((response) => {
  ...
  return (
    <Page title={t("description.sidebarCategory")}>
      <Container>
        <Stack
          direction="row"
          alignItems="center"
        ...
        >
          <DialogTitle>{t("description.CategoryPageNewButton")}</DialogTitle>
        ...
        <Card>
          <UserListToolbar
            placeHolder={t("description.categoriesPageSearchPlaceholder")}
